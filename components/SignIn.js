    ...
    <main className="w-full min-w-0 max-w-2xl mx-auto px-4 sm:px-6">
        ...
        <div className='flex flex-col overflow-hidden shadow-md shadow-slate-500 gb-slate-800 rounded-2xl'>
                <div className='h-52'>
                    ...
                    src="https://images.pexels.com/photos/4386431/pexels-photo-4386431.jpeg" alt="Finance tracking illustration" />
                </div>
                <div className='px-4 py-4'>
                    ...
                    className='flex self-start gap-2 p-3 min-h-[44px] mx-auto mt-6 text-white align-middle bg-gray-700 rounded-lg'>
