...
export default function FinanceContextProvider({children}) {
    ...
    const values =
    { income, expenses, addIncomeItem, removeIncomeItem, addExpenseItem, addCategory, deleteExpenseItem, deleteExpenseCategory,}
        ...
        const getExpensesData = async () => {
            ...
            const data = docsSnap.docs.map((doc) => {
                ...
                const normalizedItems = items
                  .map((item) => ({
                    ...item,
                    createdAt: toJsDate(item.createdAt) ?? item.createdAt,
                  }))
